...
And we execute this all below...

```{r dinosaur plot, echo = TRUE, fig.align = "center", fig.height = 5, fig.width = 5}

draw_me = list(x = c(0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 7.5, 7.5, 7.25, 7, 6.75,
...
text(draw_me$x, draw_me$y+0.1, c(1:length(y))) 
